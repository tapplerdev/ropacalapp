...
abstract class $NavigationPageStateCopyWith<$Res> {
  ...
  $Res call({
    ...
    bool isNavigating,
    int currentBinIndex,
    Map<String, RouteBin> markerToTaskMap,
...
class _$NavigationPageStateImpl implements _NavigationPageState {
  const _$NavigationPageStateImpl({
    ...
    final Map<String, RouteBin> markerToTaskMap = const {},
    this.currentStep,
  ...
  }) : _markerToTaskMap = markerToTaskMap,
  ...
  @JsonKey()
  Map<String, RouteBin> get markerToTaskMap {
    if (_markerToTaskMap is EqualUnmodifiableMapView) return _markerToTaskMap;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableMapView(_markerToTaskMap);
  }
...
abstract class _NavigationPageState implements NavigationPageState {
  const factory _NavigationPageState({
    ...
    final bool isNavigating,
    final int currentBinIndex,
    final Map<String, RouteBin> markerToTaskMap,
    final RouteStep? currentStep,
    final double distanceToNextManeuver,
    final Duration? remainingTime,
    final double? totalDistanceRemaining,
